...
REM TODO: /wd4100 for debug builds only
set CommonCompilerFlags=-DAPOCALYPSE_INTERNAL=1 -DAPOCALYPSE_SLOW=1 -DAPOCALYPSE_WIN32 -MTd -nologo -GR- -EHa- -Oi -Od -W4 -FC -Z7 -w44062 /wd4533 /wd4100
